...
%%
% Compute the Resubstitution Error(1), Crossvalidation (2), KfoldLoss (3), the
% Labels (4)
...
% Can you explain the different results obtained by the two classifiers?
...
% Use the matlab view function in graph mode to visualize the tree.
...
% Compute the cutoff throught the mincost, secost and minloc
...
% Prune the tree (call it pt). The level of pruning should be the variable
% bestlevel
